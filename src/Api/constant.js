...
const OrderListData = [
  ...
  {
    order_id: '6409134852',
    order_date: 1672972800,
    order_status: 'Confirmed',
    productDetail: [vegetables[1], vegetables[2], vegetables[3]],
    total_amount: '',
  ...
  {
    order_id: '8691570164',
    order_date: 1673491200,
    order_status: 'Processing',
    productDetail: [vegetables[1], vegetables[2], vegetables[3]],
    total_amount: '',
    paymentMethod: 'Cash',
    order_processing_date: 1673491200,
    order_confirmed_date: 1673491200,
    order_shipped_date: '',
    order_delivered_date: '',
    order_canceled_date: '',
  },
  {
    order_id: '6427435132',
    order_date: 1656144000,
    order_status: 'Processing',
    productDetail: [vegetables[0], vegetables[1], vegetables[2]],
    total_amount: '',
    paymentMethod: 'Debit Card',
    order_processing_date: 1656144000,
    order_confirmed_date: 1656144000,
    order_shipped_date: '',
    order_delivered_date: '',
    order_canceled_date: '',
  },
  {
    order_id: '2918977249',
    order_date: 1687075200,
    order_status: 'Shipped',
    productDetail: [vegetables[3], vegetables[4], vegetables[5]],
    total_amount: '',
    paymentMethod: 'PayPal',
    order_shipped_date: 1687075200,
    order_confirmed_date: 1687075200,
    order_processing_date: 1687075200,
    order_delivered_date: '',
    order_canceled_date: '',
  },
  {
    order_id: '5813267892',
    order_date: 1621881600,
    order_status: 'Shipped',
    productDetail: [vegetables[6], vegetables[7], vegetables[8]],
    total_amount: '',
    paymentMethod: 'Debit Card',
    order_shipped_date: 1621881600,
    order_confirmed_date: 1621881600,
    order_processing_date: 1621881600,
    order_delivered_date: '',
    order_canceled_date: '',
  },
  {
    order_id: '4256871389',
    order_date: 1648886400,
    order_status: 'Delivered',
    productDetail: [MeatFish[0], vegetables[0]],
    total_amount: '',
    paymentMethod: 'PayPal',
    order_delivered_date: 1648886400,
    order_confirmed_date: 1648886400,
    order_processing_date: 1648886400,
    order_shipped_date: 1648886400,
    order_canceled_date: '',
  },
  {
    order_id: '8045196378',
    order_date: 1647945600,
    order_status: 'Delivered',
    productDetail: [MeatFish[0], vegetables[0]],
    total_amount: '',
    paymentMethod: 'Cash',
  ...
  {
    order_id: '2517689492',
    order_date: 1685155200,
    order_status: 'Canceled',
    productDetail: [MeatFish[0], vegetables[0]],
    total_amount: '',
    paymentMethod: 'PayPal',
    order_canceled_date: '01-03-2023',
    order_confirmed_date: '',
    order_processing_date: '',
    order_shipped_date: '',
    order_canceled_date: 1648886400,
  },
  {
    order_id: '3185762409',
    order_date: 1621958400,
    order_status: 'Canceled',
    productDetail: [MeatFish[0], vegetables[0]],
    total_amount: '',
    paymentMethod: 'Credit Card',
    order_canceled_date: '26-05-2021',
    order_confirmed_date: '',
    order_processing_date: '',
    order_shipped_date: '',
    order_canceled_date: 1648886400,
